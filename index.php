    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <button class="btn btn-light mb-3 float-right" onclick="clearError()" data-toggle="modal" data-target="#uploadModal">Upload</button>
                    </div>
                </div>
                <div class="row mb-3">
                    <?php
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p id="uploadError"></p>
                        <!-- in here we place the notification. -->
                    </div>
                    <div class="modal-footer">
                        <!-- <form action="upload.php" method="POST" enctype="multipart/form-data"> -->
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" onclick="uploadFile()" name="submit">Upload</button>
                        <!-- </form> -->
                    </div>
                </div>
            </div>
